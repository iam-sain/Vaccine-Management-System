...
void Vaccine::showData()//3
{
    ...
    cout<<"\t\t Body temperature(C) is : "<<temperature<<endl;
...
int password()//b
{
    ...
    cin>>capt;
    if( (strcmp(cname,"Vaccine Management")==0) && (strcmp(pass,"kis322451")==0) && cap==capt)
        return 1;
    else
        return 0;
}
